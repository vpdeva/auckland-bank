...
const AttestedDataRegistryAddress = '0x3ca6a245dd648ba709128694230d0efc83d89ae0';
const serviceUPortId = '2oq7UeRYJXTZ4HJFavRWdZbME37Wxa3j2TV';
const Connect = window.uportconnect.Connect;
const connect =  new Connect('Auckland Bank', {
...
const uportConnect = function () {
    web3.eth.getCoinbase((error, address) => {
        ...
        globalState.serviceName = 'Auckland Bank';

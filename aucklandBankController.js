...
var serviceUportApp = 'Auckland Bank';
var serviceUportId = '2oq7UeRYJXTZ4HJFavRWdZbME37Wxa3j2TV';
var serviceUportPublicKey = '41cc3fb0d0f9febedd0b03d8978562642ee0962c8cc6844dcca9ba1adb503744';
...
exports.index = (req, res, next) => {
    res.render('index', { title: 'Auckland Bank', serviceUportId:  serviceUportId, serviceUportApp: serviceUportApp});
}
...
exports.thanks = (req, res, next) =>{
    ...
    aucklandBankDb.saveRequest(userRequest);
    res.render('thanks');
};
...
exports.checkLogin = (req, res, next) => {
    ...
    if( username && username==='admin' && password && password==='admin') {
        ...
        res.render('adminDashboard', { title: 'Auckland Bank', serviceUportId:  serviceUportId, serviceUportApp: serviceUportApp});
    } else {
        //TODO
...
exports.enterIdentityData = (req, res, next) =>{
    ...
    aucklandBankDb.loadRequest(accountId, (data) => {
...
exports.viewRequests = (req, res, next) =>{
    aucklandBankDb.loadRequests((data) => {
...
exports.cbAttestData = (req, res, next) =>{
    if(req.query['attestations']) {
        ...
        aucklandBankDb.addPayload(result.payload.sub, JSON.stringify(result.payload));
    }
};
